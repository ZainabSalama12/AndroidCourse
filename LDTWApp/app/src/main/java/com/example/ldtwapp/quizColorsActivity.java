...
public class quizColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_colors);
            ...
            public void onClick(View view) {
                if(answered==false){
                    if(opt1.isChecked()||opt2.isChecked()||opt3.isChecked()||opt4.isChecked()){
                        ...
                        Toast.makeText(quizColorsActivity.this, "Please select any option", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    showNextQuestion();
    ...
    private void addQuestion() {
            questionList.add(new QuestionModel("What is the color of Apple?","Red","Black","Purple","White",1));
            questionList.add(new QuestionModel("What is the color of lion?","Red","Yellow and Brown","Black","White",2));
            questionList.add(new QuestionModel("Which fruit has a Red color?","Mango","Kiwi","Banana","Apple",3));
            questionList.add(new QuestionModel("The color of the sky is","Purple","Yellow","Red","blue",4));
    }
}